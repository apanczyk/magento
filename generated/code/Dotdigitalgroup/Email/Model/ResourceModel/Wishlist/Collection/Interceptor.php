...
class Interceptor extends \Dotdigitalgroup\Email\Model\ResourceModel\Wishlist\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWishlistById');
        return $pluginInfo ? $this->___callPlugins('getWishlistById', func_get_args(), $pluginInfo) : parent::getWishlistById($wishListId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWishlistByIdAndStoreId');
        return $pluginInfo ? $this->___callPlugins('getWishlistByIdAndStoreId', func_get_args(), $pluginInfo) : parent::getWishlistByIdAndStoreId($wishListId, $storeId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWishlistsToImportByWebsite');
        return $pluginInfo ? $this->___callPlugins('getWishlistsToImportByWebsite', func_get_args(), $pluginInfo) : parent::getWishlistsToImportByWebsite($website, $limit);
    }
